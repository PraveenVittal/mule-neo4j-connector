...
public class UpdateNodesMessageProcessorDebuggable
    extends UpdateNodesMessageProcessor
    implements DebugInfoProvider
{


    public UpdateNodesMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("setParameters", "Set parameters", (java.util.Map.class), setParameters, muleEvent));
