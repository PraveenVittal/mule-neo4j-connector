...
/**
 * UpdateNodesMessageProcessor invokes the {@link org.mule.modules.neo4j.internal.connector.Neo4jConnector#updateNodes(java.lang.String, java.util.Map, java.util.Map)} method in {@link Neo4jConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-06-29T06:11:54-03:00", comments = "Build UNNAMED.2793.f49b6c7")
public class UpdateNodesMessageProcessor
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    protected Object setParameters;
    protected Map<String, Object> _setParametersType;

    public UpdateNodesMessageProcessor(String operationName) {
        super(operationName);
    }
     ...
     */
    public void setSetParameters(Object value) {
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedLabel = ((String) evaluateAndTransform(getMuleContext(), event, UpdateNodesMessageProcessor.class.getDeclaredField("_labelType").getGenericType(), null, label));
            final Map<String, Object> _transformedParameters = ((Map<String, Object> ) evaluateAndTransform(getMuleContext(), event, UpdateNodesMessageProcessor.class.getDeclaredField("_parametersType").getGenericType(), null, parameters));
            final Map<String, Object> _transformedSetParameters = ((Map<String, Object> ) evaluateAndTransform(getMuleContext(), event, UpdateNodesMessageProcessor.class.getDeclaredField("_setParametersType").getGenericType(), null, setParameters));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                {
                    try {
                        ((Neo4jConnector) object).updateNodes(_transformedLabel, _transformedParameters, _transformedSetParameters);
                        return null;
                    } catch (Exception e) {
    ...
    public Result<MetaData> getInputMetaData() {
        if (((label) == null)||((label).toString() == null)) {
            return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error retrieving metadata from parameter: label at processor updateNodes at module Neo4jConnector");
        }
        DefaultMetaDataKey metaDataKey = new DefaultMetaDataKey((label).toString(), null);
        metaDataKey.setCategory("InvokeMetaData");
        metaDataKey.addProperty(new TypeDescribingProperty(TypeDescribingProperty.TypeScope.INPUT, "updateNodes"));
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at Neo4jConnector at updateNodes retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
