...
public class SelectNodesMessageProcessorDebuggable
    extends SelectNodesMessageProcessor
    implements DebugInfoProvider
{


    public SelectNodesMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
