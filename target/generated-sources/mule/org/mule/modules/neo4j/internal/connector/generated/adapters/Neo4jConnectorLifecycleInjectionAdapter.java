...
/**
 * A <code>Neo4jConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link Neo4jConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-06-29T06:11:54-03:00", comments = "Build UNNAMED.2793.f49b6c7")
public class Neo4jConnectorLifecycleInjectionAdapter
    extends Neo4jConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(Neo4jConnectorLifecycleInjectionAdapter.class);
