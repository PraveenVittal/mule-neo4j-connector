...
/**
 * DeleteNodesMessageProcessor invokes the {@link org.mule.modules.neo4j.internal.connector.Neo4jConnector#deleteNodes(java.lang.String, boolean, java.util.Map)} method in {@link Neo4jConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-06-29T06:11:54-03:00", comments = "Build UNNAMED.2793.f49b6c7")
public class DeleteNodesMessageProcessor
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    protected Object removeRelationships;
    protected boolean _removeRelationshipsType;
    protected Object parameters;
    protected Map<String, Object> _parametersType;

    public DeleteNodesMessageProcessor(String operationName) {
        super(operationName);
    }
    ...
    /**
     * Sets removeRelationships
     * 
     * @param value Value to set
     */
    public void setRemoveRelationships(Object value) {
        this.removeRelationships = value;
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedLabel = ((String) evaluateAndTransform(getMuleContext(), event, DeleteNodesMessageProcessor.class.getDeclaredField("_labelType").getGenericType(), null, label));
            final Boolean _transformedRemoveRelationships = ((Boolean) evaluateAndTransform(getMuleContext(), event, DeleteNodesMessageProcessor.class.getDeclaredField("_removeRelationshipsType").getGenericType(), null, removeRelationships));
            final Map<String, Object> _transformedParameters = ((Map<String, Object> ) evaluateAndTransform(getMuleContext(), event, DeleteNodesMessageProcessor.class.getDeclaredField("_parametersType").getGenericType(), null, parameters));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                {
                    try {
                        ((Neo4jConnector) object).deleteNodes(_transformedLabel, _transformedRemoveRelationships, _transformedParameters);
                        return null;
                    } catch (Exception e) {
    ...
    public Result<MetaData> getInputMetaData() {
        if (((label) == null)||((label).toString() == null)) {
            return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error retrieving metadata from parameter: label at processor deleteNodes at module Neo4jConnector");
        }
        DefaultMetaDataKey metaDataKey = new DefaultMetaDataKey((label).toString(), null);
        metaDataKey.setCategory("InvokeMetaData");
        metaDataKey.addProperty(new TypeDescribingProperty(TypeDescribingProperty.TypeScope.INPUT, "deleteNodes"));
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at Neo4jConnector at deleteNodes retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
