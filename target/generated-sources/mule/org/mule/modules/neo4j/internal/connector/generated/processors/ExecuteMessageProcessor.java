...
/**
 * ExecuteMessageProcessor invokes the {@link org.mule.modules.neo4j.internal.connector.Neo4jConnector#execute(java.lang.String, java.util.Map)} method in {@link Neo4jConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedQuery = ((String) evaluateAndTransform(getMuleContext(), event, ExecuteMessageProcessor.class.getDeclaredField("_queryType").getGenericType(), null, query));
            final Map<String, Object> _transformedParameters = ((Map<String, Object> ) evaluateAndTransform(getMuleContext(), event, ExecuteMessageProcessor.class.getDeclaredField("_parametersType").getGenericType(), null, parameters));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                {
                    try {
                        return ((Neo4jConnector) object).execute(_transformedQuery, _transformedParameters);
                    } catch (Exception e) {
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at Neo4jConnector at execute retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
