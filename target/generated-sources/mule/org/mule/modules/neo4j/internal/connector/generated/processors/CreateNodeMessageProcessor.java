...
/**
 * CreateNodeMessageProcessor invokes the {@link org.mule.modules.neo4j.internal.connector.Neo4jConnector#createNode(java.lang.String, java.util.Map)} method in {@link Neo4jConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public CreateNodeMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedLabel = ((String) evaluateAndTransform(getMuleContext(), event, CreateNodeMessageProcessor.class.getDeclaredField("_labelType").getGenericType(), null, label));
            final Map<String, Object> _transformedParameters = ((Map<String, Object> ) evaluateAndTransform(getMuleContext(), event, CreateNodeMessageProcessor.class.getDeclaredField("_parametersType").getGenericType(), null, parameters));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                {
                    try {
                        ((Neo4jConnector) object).createNode(_transformedLabel, _transformedParameters);
                        return null;
                    } catch (Exception e) {
    ...
    public Result<MetaData> getInputMetaData() {
        if (((label) == null)||((label).toString() == null)) {
            return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error retrieving metadata from parameter: label at processor createNode at module Neo4jConnector");
        }
        DefaultMetaDataKey metaDataKey = new DefaultMetaDataKey((label).toString(), null);
        metaDataKey.setCategory("InvokeMetaData");
        metaDataKey.addProperty(new TypeDescribingProperty(TypeDescribingProperty.TypeScope.INPUT, "createNode"));
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at Neo4jConnector at createNode retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
