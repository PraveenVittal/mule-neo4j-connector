...
public class DeleteNodesMessageProcessorDebuggable
    extends DeleteNodesMessageProcessor
    implements DebugInfoProvider
{


    public DeleteNodesMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("removeRelationships", "Also remove existing relationships", (boolean.class), removeRelationships, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("label", "Label", (java.lang.String.class), label, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("parameters", "Parameters", (java.util.Map.class), parameters, muleEvent));
